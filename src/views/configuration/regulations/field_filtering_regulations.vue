    ...
    >
      ...
      >
        ...
        <el-form-item label="规则：" prop="domainRule">
          <el-input
            v-model.trim="ruleForm.domainRule"
            placeholder="请输入规则"
          />
        </el-form-item>
        <el-form-item label="规则分类：" prop="domainRuleClassify">
          <el-input
            v-model.trim="ruleForm.domainRuleClassify"
            placeholder="请输入分类信息"
          />
        </el-form-item>
    ...
    return {
      ...
      tableData: {
        ...
        header: [
          {
            label: '规则', // 表头名称
            propName: 'domainRule', // 查询返回的字段名
          },
          {
            label: '分类',
            propName: 'domainRuleClassify',
            width: '100px',
          },
          {
            label: '所属方案',
