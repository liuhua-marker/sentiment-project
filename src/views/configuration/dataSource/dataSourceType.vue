  ...
  <div class="app-container box">
    ...
    <div class="app-table">
      ...
      <el-table v-loading="loading" :data="quanWordList" class="app-table-list" border>
        ...
        <el-table-column label="数据源类型" prop="typeName" />
        ...
        <el-table-column label="选择">
          <template slot-scope="scope">
            ...
            <el-button type="danger" size="small" @click="handleDelete([scope.row.sourceTypeId])">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
...
export default {
  ...
  methods: {
    // 获取页面数据
    async getQuanIndex() {
      const data = await confdatasourcetype(this.queryForm)
    ...
    clearDialog() {
      this.addRuleForm.typeName = ''
      this.addRuleForm.typeCode = ''
