...
export function page(data) {
  return request({
    url: `/yuqing-configuration/confnegativewordrules/list`,
    method: 'POST',
    data
  })
}
...
export function save(data) {
  return request({
    url: `/yuqing-configuration/confnegativewordrules/save`,
    method: 'POST',
    data
  })
}
...
export function handleDelete(ids) {
  return request({
    url: `/yuqing-configuration/confnegativewordrules/delete`,
    method: 'DELETE',
    data: ids
  })
}
...
export function editeQuanIndexFrom(data) {
  return request({
    url: `/yuqing-configuration/confnegativewordrules/update`,
    method: 'PUT',
    data
  })
}
...
export function domnLoadModel() {
  return request({
    url: `/yuqing-configuration/confnegativewordrules/exportTemplate`,
    responseType: 'blob',
    method: 'GET'
  })
}
